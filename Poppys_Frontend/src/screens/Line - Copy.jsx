...
export default function Line({
  ...
  const getTileDataFromFiltered = () => {
    ...
    const hasBackendTileData =
      firstRow.tile1_productive_time &&
    ...
    if (hasBackendTileData) {
      ...
      return [
        {
          label: "Productive Time %",
          value: `${(firstRow.tile1_productive_time.percentage || 0).toFixed(
            2
          )}%`,
          bg: "tile-bg-blue",
          color: "tile-color-blue",
        ...
        },
        {
          label: "Sewing Speed",
          value: Math.round(
            firstRow.tile3_sewing_speed.average_spm || 0
          ).toString(),
          bg: "tile-bg-orange",
          color: "tile-color-orange",
        },
        {
          ...
          value: convertHHMMToHoursMinutes(
            firstRow.tile4_total_hours.total_hours || "00:00"
          ),
          bg: "tile-bg-pink",
          color: "tile-color-pink",
        },
