...
INSTALLED_APPS = [
    ...
    'machine_log_api.apps.MachineLogApiConfig',
]
...
LOGGING = {
    ...
    'project_file': {
        ...
        'filename': os.path.join(BASE_DIR, 'poppys_project.log'),
        'formatter': 'detailed',
    },
    'console': {
        'level': 'DEBUG',
...
'loggers': {
    'poppys': {
        'handlers': ['project_file', 'console'],
        'level': 'DEBUG',
        'propagate': False,
    },
        # Optionally, log all Django requests:
        'django.request': {
